...
public class Banco {
    ...
    public Banco(String correntista1, ContaCorrente co1, String
                         correntista2,
    ...
    public double getSaldo(String nomeCorrentista){
        return
                getCorrentista(nomeCorrentista).getConta().getValor();
    }

    public void transferir(String nomeCorrentistaOrigem, String
            nomeCorrentistaDestino, double valor){
